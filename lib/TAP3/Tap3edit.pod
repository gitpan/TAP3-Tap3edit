=head1 NAME
  ...
  TAP3::Tap3edit - TAP3 and RAP files Encode/Decode library
...
TAP3::Tap3edit decodes and encodes TAP and RAP files using ASN.1 format, storing its tree information into a hash.
...
Decodes the tree structure of a TAP/RAP file into a HASH.

=item encode:

Encodes the structure opened by "decode" into a new TAP/RAP file.
...
Gets only the basic information of the TAP/RAP file such as its version, release and file type.

=item spec_file:

Normaly the ASN.1 specifications files are stored in the "Spec" directory from the installation directory, but this method allows to use a certain specification file to decode our TAP/RAP file. 
...
Returns the main version of the TAP/RAP file.

=item release:

Returns the main release of the TAP/RAP file.
...
Returns the type of the file, TAP for CD and TD files, and RAP for RC and RT files.
...
Decode a TAP file with a certain specification file
  ...
  $tap3->asn_filename("/home/javier/MySpec/TAP0304.asn");
...
Convert::ASN1 from Graham Barr <gbarr@pobox.com>, which is the main motor of Tap3edit.

=head1 AUTHOR

Javier Gutierrez <javier.gutierrez@tap3edit.com>

=head1 COPYRIGHT

Copyright (c) 2004 Javier Gutierrez. All rights reserved. <javier.gutierrez@tap3edit.com> This program is free software; you can redistribute it and/or modify it under the same terms as Perl itself.
